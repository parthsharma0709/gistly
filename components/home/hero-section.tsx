...
export default function HeroSection() {
  return (
    <section className="relative mx-auto flex flex-col  z-0 items-center justify-center py-16 sm:py-20 lg:pb-28 transition-all animate-in lg:px-12 max-w-7xl">
      <div>
        ...
        <h1 className="mt-4 text-5xl text-center py-6 font-bold">
  Transform PDFs into{' '}
  ...
  summaries
        ...
        <h2 className="text-lg text-gray-600 sm:text-xl lg:text-2xl text-center px-4 lg:px-0 lg:max-w-4xl ">
